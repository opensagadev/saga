...
![Progress](https://img.shields.io/badge/matching-38.30%25-orange)
...
| `legoapi/characters` | 33.0% | 18.6% |
| `legoapi/core` | 30.9% | 20.6% |
| `legoapi/cutscenes` | 36.6% | 15.2% |
| `legoapi/gizmo` | 41.0% | 36.5% |
| `legoapi/gizmos` | 49.5% | 47.3% |
| `legoapi/items` | 38.1% | 37.9% |
| `legoapi/menus` | 26.7% | 27.6% |
| `legoapi/misc` | 27.5% | 12.5% |
| `legoapi/props` | 48.1% | 11.2% |
| `legoapi/render` | 35.0% | 25.3% |
| `legoapi/world` | 28.2% | 30.4% |
| `legogame` | 50.8% | 60.0% |
| `nu2api` | 57.8% | 54.3% |
