...
At the latest measured target build, there are 530 current translation
units and a 45.8770% whole-binary fuzzy match. This is a
source-ownership overview, not a claim that 45.8770% of the original file
