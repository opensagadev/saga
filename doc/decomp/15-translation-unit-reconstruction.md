...
At the latest measured target build, there are 488 current translation
units, 4,762 exact functions, and a 46.1104% whole-binary fuzzy match. The independent structural
dashboard reports 48.3% largest-run text grouping and 99.8% of assessable
same-TU writable-state links satisfied (47.5% of original links are
...
All 488 current units emit at least one named symbol. Six have no matched
...
27 with one. This is a review queue, not a deletion rule: some are legitimate
