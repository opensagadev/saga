...
DECOMP_ASSERT(offsetof(aieditor_settings_s, area_rotation) == 0x40, "editor area rotation offset");
...
DECOMP_ASSERT(offsetof(aieditor_settings_s, elapsed_time) == 0x64, "editor elapsed time offset");
