...
// Terrain/graph editor UI/menu callback stubs (static, internal linkage).
// edgra* symbols from edtools_other_B.txt.
...
static void edgracbChangeInstanceType(eduimenu_s *, eduiitem_s *, u32) {
    STUBBED();
}
