...
// sub-menus (edui menu system). They are stubbed because the editor menu
// code is not being decompiled.
...
// Menu/colour-pick callback with extra args.
