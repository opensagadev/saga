...
void NuGLES2ExtensionsInit() {
    host_glGetProgramBinaryOES =
        reinterpret_cast<decltype(host_glGetProgramBinaryOES)>(eglGetProcAddress("glGetProgramBinaryOES"));
    host_glProgramBinaryOES =
        reinterpret_cast<decltype(host_glProgramBinaryOES)>(eglGetProcAddress("glProgramBinaryOES"));
    host_glDiscardFramebufferEXT =
        reinterpret_cast<decltype(host_glDiscardFramebufferEXT)>(eglGetProcAddress("glDiscardFramebufferEXT"));
    host_glGenVertexArraysOES =
        reinterpret_cast<decltype(host_glGenVertexArraysOES)>(eglGetProcAddress("glGenVertexArraysOES"));
    host_glBindVertexArrayOES =
        reinterpret_cast<decltype(host_glBindVertexArrayOES)>(eglGetProcAddress("glBindVertexArrayOES"));
    host_glDeleteVertexArraysOES =
        reinterpret_cast<decltype(host_glDeleteVertexArraysOES)>(eglGetProcAddress("glDeleteVertexArraysOES"));
}
