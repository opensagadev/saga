...
extern "C" {
    ...
    i32 NuFadeObjMtxIndex;
    i32 NuFadeObjDataIndex;
    i32 NuFadeObjWave;
    i32 NuFadeObjDir;
    i32 NuFadeObjDir2;
    i32 stopfadeup;
...
extern "C" void NuFadeObjInit(void) {
    i16 *platform;
    i32 group, i;
    void *terrain;
    NuFadeObjDir = 0;
...
extern "C" void NuFadeObjSet_SetLightsFn(void (*global_lights)(void), void (*object_lights)(void)) {
...
extern "C" NuFadeObjGType *NuFadeObjCreateMtx(nuhspecial_s *source, NUMTX *matrices, i16 count, f32 near_distance,
...
extern "C" void NuFadeObjUpdateArray(NUVEC **positions) {
    i32 i, g, p, nearby;
    NUMTX *matrix;
    i16 *platform;
...
extern "C" void NuFadeObjUpdate(NUVEC *position) {
    i32 i;
    NUVEC *positions[8];
    for (i = 1; i < 8; ++i)
        positions[i] = NULL;
...
extern "C" void NuFadeObjDraw(void) {
    i32 i, g;
    NUMTX *matrix;
    NuFadeObjGType *group;
...
extern "C" void NuFadeObjSetup(VARIPTR *buffer, VARIPTR, i32 matrix_count, i32 group_count) {
